...
with Pyro5.api.Proxy(uri) as proxy:
    ...
    Pyro5.api.current_context.annotations = {"XYZZ": b"custom annotation from client via new way(1)"}
    ...
    print("\noneway call")
    Pyro5.api.current_context.annotations = {"XYZZ": b"custom annotation from client via new way(2)"}
