...
Make sure you first start the gateway, for instance:
    ...
    python -m Pyro5.utils.httpgateway -e 'Pyro.|test.'
    or: pyro5-httpgateway -e 'Pyro.|test.'
...
... and ofcourse, try opening the url that the server printed in your web browser.
