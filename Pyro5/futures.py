...
log = logging.getLogger("Pyro5.futures")
...
class _ExceptionWrapper(object):
    ...
    def raiseIt(self):
        from Pyro5.util import fixIronPythonExceptionForPickle  # XXX circular
        if sys.platform == "cli":
    ...
    def __serialized_dict__(self):
        ...
        from Pyro5.util import SerializerBase  # XXX circular
        return {
            "__class__": "Pyro5.futures._ExceptionWrapper",
