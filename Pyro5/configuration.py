...
class Configuration(object):
    __slots__ = ("HOST", "NS_HOST", "NS_PORT", "NS_BCPORT", "NS_BCHOST", "NS_AUTOCLEAN",
                 "NATHOST", "NATPORT", "COMPRESSION", "SERVERTYPE", "COMMTIMEOUT", "POLLTIMEOUT",
                 "MAX_RETRIES", "SOCK_REUSE", "SOCK_NODELAY", "ONEWAY_THREADED",
                 "DETAILED_TRACEBACK", "THREADPOOL_SIZE", "THREADPOOL_SIZE_MIN", "MAX_MESSAGE_SIZE",
                 "BROADCAST_ADDRS", "PREFER_IP_VERSION",
                 "SERIALIZER", "SERIALIZERS_ACCEPTED", "LOGWIRE",
